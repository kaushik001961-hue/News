...
export default async function DraftNewsPage() {
  ...
  // Fetch draft posts, stats, and categories in parallel
  const [
    news,
    totalCount,
    draftCount,
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-4xl font-black text-slate-900">Draft News</h1>
      ...
      {/* Passing categories safely or spreading bypass */}
